...
<?= do_shortcode("[views section=general name=navbarView]") ?>
    <div id="checkout" class="flex text-emerald-900 w-11/12 mx-auto max-w-screen-xl p-5 md:p-20 gap-2 flex-col-reverse md:flex-row">
        <div class="w-full">
            ...
            <form id="formDataOrder" action="#">
                ...
                <div data-step="1" class="">
                            ...
                            <div class="flex-1">
                                ...
                                <div class="mt-6 mb-4 internetBanking hidden">
                                    ...
                                    <ul class="mt-3.5 text-sm text-slate-500 space-y-2">
                                        ...
                                        <li>Bank name: <span class="text-slate-900 font-medium">Example Bank Name</span></li>
                                        <li>IBAN: <span class="text-slate-900 font-medium">IBAN</span></li>
                                        <li>BIC: <span class="text-slate-900 font-medium">BIC/Swift</span></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                    ...
                    <div>
                        <button type="button" class="uppercase text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none
        ...
        <div class="flex-shrink-0 border-t lg:border-t-0 lg:border-l border-emerald-200 my-10 lg:my-0 lg:mx-10 xl:lg:mx-14 2xl:mx-16"></div>
        <div class="w-full lg:w-2/5">
            ...
            <div class="mt-10 border-t border-slate-200/70 pt-6 text-sm text-slate-500">
                ...
                <div class="flex justify-between py-2.5 hidden">
        ...
        <div class="relative w-full max-w-md max-h-full">
            <div class="relative bg-emerald-200 rounded-lg shadow">
                ...
                rounded-lg text-sm p-1.5 ml-auto inline-flex items-center">
                    ...
                    .org/2000/svg"><path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
                    <span class="sr-only">Close modal</span>
                </button>
                <div class="p-6 text-center">
                    <svg aria-hidden="true" class="mx-auto mb-4 text-gray-400 w-14 h-14 stroke-emerald-900" fill="none"
                         stroke="currentColor" viewBox="0 0
                    24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
