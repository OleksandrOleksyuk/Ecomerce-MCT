...
<main class="text-emerald-900">
    <section class="flex flex-col lg:flex-row-reverse mx-auto justify-center items-center max-w-7xl p-10">
        ...
        <div class="lg:w-1/2 md:p-10">
            <div class="space-y-2">
                <p class="uppercase tracking-widest"><?= $product['categories']; ?></p>
                <h1 class="text-emerald-900 text-4xl lg:text-5xl"><?= $product['name']; ?></h1>
            ...
            <div class="flex items-center justify-between gap-5 mt-5">
                <div>
                    <h3 class="text-5xl font-semibold text-emerald-600 py-2">
                        <?= '€ ' . $product['price']; ?>
                    </h3>
                </div>
