...
<main id="singleProduct" class="text-emerald-900">
    <section class="flex flex-col lg:flex-row-reverse mx-auto justify-center items-center max-w-7xl p-10">
        <div class="lg:w-1/2 flex flex-col sm:flex-row-reverse lg:flex-col justify-center items-center lg:items-start p-5">
        ...
        <div class="lg:w-1/2 md:p-10">
            <div class="space-y-2">
                ...
                <div>
                    ...
                    <div id="colorSingleProduct" class="flex gap-2 flex-wrap">
                        ...
                        ?>
                            <img data-color="<?= $color; ?>" data-image="<?= $value['image']; ?>" class="h-10 w-10 rounded-full object-cover cursor-pointer <?= $active; ?>" src="<?= $image_src; ?>" alt="">
                        <?php
                        };
                        ?>
                    </div>
            ...
            <div class="flex items-center justify-between gap-5 mt-5">
                ...
                <div class="flex gap-5">
                    ...
                    <a id="addToSidebarBtn" href="#" class="bg-emerald-600 inline-flex items-center justify-center rounded-lg py-3 px-6 text-center text-base font-medium text-white hover:bg-opacity-90">
                        <span class="mr-[10px]">
