...
<div data-link="<?= $product["link"] ?>" data-parent="<?= strtolower($product["data-parent"]) ?>"
     ...
     class="opacity-0 -translate-y-32 duration-500 cardView col-span-1 mb-10 w-80 h-[410px] rounded-xl text-slate-900 swiper-slide shadow-lg md:hover:shadow-lg md:hover:shadow-pink-600">
    <div class="w-80 h-[410px] text-left flex flex-col rounded-xl">
        <div id="containerImageCard" class="flex h-[180px] items-center justify-center overflow-hidden relative rounded-t-xl">
            <?= $product["image"] ?>
        ...
        <div class="flex flex-col justify-between h-[230px] p-5">
            <div>
