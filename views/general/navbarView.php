                        ...
                        <div class="overflow-hidden rounded-2xl shadow-lg ring-1 ring-black/5">
                            <div class="relative bg-white">
                                <div class="p-5">
                                    ...
                                    <div id="containerSidebarProduct" class="divide-y divide-slate-100 overflow-y-auto max-h-[60vh]"></div>
                                </div>
                                <div class="bg-neutral-50 p-5">
                                    <p class="flex justify-between font-semibold text-slate-900 text-left">
                                        <span><span>Subtotal</span><span class="block text-sm font-normal text-slate-500">Shipping and taxes calculated at checkout.</span></span><span id="sumPrice" class="">$299.00</span>
                                    </p>
