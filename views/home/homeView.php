...
<div class="text-emerald-900">
    ...
    <header class="py-10 lg:py-20 w-11/12 mx-auto max-w-7xl">
        ...
        <div class="flex flex-col-reverse sm:flex-row justify-center items-center pb-10 gap-10">
            <div class="flex flex-col gap-2 max-w-2xl">
                <div class="text-left">
                    ...
                    <p class="text-lg md:text-xl lg:text-2xl xl:text-3xl mb-1 md:mb-5">Il tuo negozio online per il
                        cucito creativo</p>
        ...
        <!-- brand -->
        <div class="flex justify-center items-center gap-10 pt-5 opacity-0 translate-y-52 duration-700 FadeDown">
            <?php
    ...
    <main class="space-y-20">
        <section id="welcome" class="FadeDown bg-emerald-50 py-5 flex flex-col items-center px-5 md:px-10">
            <div class="flex flex-col md:grid md:grid-cols-3 text-left py-5 w-11/12 mx-auto max-w-7xl">
                ...
                <div class="col-span-2 p-2 lg:p-5">
                    <p class="lg:text-lg xl:text-xl mb-5">Da Merceria Creativa Tania troverai tutto ciò di cui hai
                        bisogno per dare vita ai tuoi progetti di <span class="font-bold text-emerald-600">cucito</span> e <span class="font-bold text-emerald-600">sartoria</span>, dai tessuti di <span class="font-bold text-emerald-600">alta qualità</span> ai bottoni <span class="font-bold text-emerald-600">esclusivi</span> e agli accessori più <span class="font-bold text-emerald-600">ricercati</span>. Siamo qui per aiutarti a dare forma
                        alle tue idee e a creare capi unici e sorprendenti.</p>
                    <p class="text-xl xl:text-2xl text-emerald-600 font-semibold">Esplora il nostro negozio online e
                        scopri l'infinita possibilità di creazione!</p>
                </div>
            </div>
        </section>
        <!-- best-selling products -->
        <section id="bestSellingProducts" class="section opacity-0 translate-y-52 duration-700 py-5 flex flex-col items-center px-5 md:px-10">
            <div class="max-w-7xl mx-auto max-2xl:w-11/12">
                <div class="flex flex-wrap justify-between mb-5">
                    <h2 class="text-3xl md:text-4xl font-semibold text-left py-5">I più venduti<span>. </span>
                        <span class="text-neutral-500">Prodotti più venduti del mese</span>
                    </h2>
        ...
        <section class="section opacity-0 translate-y-52 duration-700 w-11/12 mx-auto max-w-7xl">
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <h2 class="text-3xl md:text-4xl font-semibold text-left py-5">Le migliori scelte<span class="">. </span><br><span class="text-neutral-500">Prodotti top per la tua categoria preferita
                </h2>
                <div class="mt-6 space-y-12 md:grid md:grid-cols-3 md:gap-x-6 md:space-y-0 text-left">
                    ...
                    $data = [
                        [
                            "img_src" => "lana.jpeg",
                            "span" => "Lana",
                            "p" => "Creare morbidi capi e accessori con la lana.",
                        ],
                        [
                            "img_src" => "uncinetto.jpeg",
                            "span" => "Uncinetto",
                            "p" => "Creare tessuti unici con l'arte dell'uncinetto.",
                        ],
                        [
                            "img_src" => "tessuti.jpeg",
                            "span" => "Tessuti",
                            "p" => "Creare moda e arredamento con tessuti unici.",
                        ],
        ...
        <section class="section opacity-0 translate-y-52 duration-700 w-11/12 max-w-7xl mx-auto hidden">
            <?= do_shortcode("[views section=general name=newsletterView]") ?>
        </section>
        <section class="section opacity-0 translate-y-52 duration-700 w-11/12 max-w-7xl mx-auto">
